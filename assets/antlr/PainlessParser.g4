...
rstatement
    // Fixed by yokoc1322/painless-lsp: The converter cannot understand _input.LA(1)
...
arrayinitializer
    : NEW type_ ( LBRACE expression RBRACE )+ ( postdot postfix* )?                        # newstandardarray
    | NEW type_ LBRACE RBRACE LBRACK ( expression ( COMMA expression )* )? RBRACK postfix* # newinitializedarray
    ;
